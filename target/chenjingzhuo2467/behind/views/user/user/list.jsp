...
<div class="layui-fluid">
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="username" placeholder="请输入要查找的用户名" autocomplete="off"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-inline">
    ...
    <div class="layui-col-md12">
        <!-- 底部固定区域 -->
        <b>Version</b> 1.0.0
        <strong>Copyright &copy; 2020-2021 编程要快乐 <a href="http://beian.miit.gov.cn/">粤ICP备20056073号</a>.</strong> All
        rights
        reserved.
    </div>
</div>
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laypage'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'birthday', title: '出生日期', align: 'center'} //minWidth：局部定义当前单元格的最小宽度，layui 2.2.1 新增
                , {field: 'tel', title: '手机号码', align: 'center'}, //minWidth：局部定义当前单元格的最小宽度，layui 2.2.1 新增
                    ...
                    layer.open({
                        ...
                        , yes: function (index, layero) {
                            ...
                            iframeWindow.layui.form.on('submit(' + submitID + ')', function (data) {
                                    ...
                                    success: function (result) {
                                        if (result.code = 100) {
                                            ...
                                            table.reload('test',function () {
                                                page: {
                                                    curr: obj.data.length-1%obj.limit==0?obj.page+1:obj.page;
                                                }
                                            }); //数据刷新
                                ...
                                /*table.reload('test',function () {
                                    page: {
                                        curr: obj.data.length%obj.limit==0
                                    }
                                }); //数据刷新*/
        ...
        table.on('tool(test)', function (obj) { //注：tool 是工具条事件名，test 是 table 原始容器的属性 lay-filter="对应的值"
            ...
            if (layEvent === 'detail') { //查看
                ...
                layer.confirm('您确定要删除【' + data.username + '】吗？', {icon: 3}, function (index) {
                    //向服务端发送删除指令
                    $.ajax({
                ...
                layer.open({
                    ...
                    , success: function (layero, index) {
                        ...
                        if (data.sex == "1"){
                            body.contents().find(":radio[name='sex']").eq(0).attr("checked","true");
                        } else {
                            body.contents().find(":radio[name='sex']").eq(1).attr("checked","true");
                        }
                        // body.contents().find("select").val(data.city);
