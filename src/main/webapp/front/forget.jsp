...
<div id="login">
    ...
    <input id="tab-3" type="radio" name="tab" class="sign-out hidden" checked/>
    <div class="wrapper">
...
<span class="input__label-content input__label-content--hideo"></span>
                ...
                <div class="form-actions">
                    <a class="btn pull-left btn-link text-muted" onclick="javascipt:location.href='login.html'">返回登录</a>
