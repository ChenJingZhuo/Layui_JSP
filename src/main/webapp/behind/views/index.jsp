        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <li class="layui-nav-item" lay-unselect style="margin-right: 10px">
            ...
            <dl class="layui-nav-child">
              <dd><a lay-href="./set/user/password.jsp">修改密码</a></dd>
              <hr>
        ...
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              <a href="javascript:;" lay-href="home/console.jsp" class="layui-this" lay-tips="主页" lay-direction="2">
            ...
            <li data-name="user" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd>
                  <a lay-href="./user/user/list.jsp">网站用户</a>
                </dd>
              </dl>
            </li>
          </ul>
